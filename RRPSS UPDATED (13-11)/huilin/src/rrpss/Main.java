...
public class Main {
	...
	public static void main(String[] args) {
		...
		do{
			...
			System.out.println("(12) View employees");
			...
			case 11:
				...
				/**
				 * this is our code for case 12
				 * where we will be able to view all the staff information
				 * first, we will read the employee file to get details of the employee
				 * then we will print it out in a table
				 */
			case 12:
				...
				//read file to get the employee details stored in the file and to update the array list 
				readEmployeeFile(employeeArr, employeeArrList, idCount);
				...
				employeeArrList.get(index).printEmployeeInfo(employeeArrList);
		...
		}while(choice != 13);//looping the switch cases if wrong insertion
